...
<script type="text/javascript">
	...
	function registerCheck() {
		...
		$.ajax({
			...
			success : function(result) {
				// 중복유무 확인(result=1: 사용가능 ID, result=2: 사용불가 ID)
				if(result==1){
	...
	function goInsert() {
		...
		document.frm.submit(); // 모두 다 작성됐을 때 전송
	}
</script>
</head>
<body>
				...
				<form name="frm" action="${contextPath}/memRegister.do"
					...
					<table class="table table-boardered"
						...
						<tr style="display: none;">
							...
							<td colspan="2">
								<input type="checkbox" name="authList[0].auth" value="ROLE_USER" checked="checked"> ROLE_USER
